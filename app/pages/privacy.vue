    ...
    <header class="relative overflow-hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-white/10 pt-24 pb-16 px-6 lg:px-12">
      ...
      <div class="max-w-6xl mx-auto relative z-10 text-center">
        ...
        <p class="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed">
          شفافیت، اصل اول ما در داناورس است. ما به حریم شخصی شما احترام می‌گذاریم و از داده‌های شما با بالاترین استانداردهای امنیتی محافظت می‌کنیم.
        </p>
...
const sections = ref([
  {
    ...
    content: [
      { type: 'text', text: 'هنگامی که از وب‌سایت داناورس استفاده می‌کنید یا در دوره‌های ما ثبت‌نام می‌نمایید، ما اطلاعات خاصی را برای ارائه خدمات بهتر جمع‌آوری می‌کنیم. این اطلاعات شامل موارد زیر است:' },
      { type: 'list', items: [
