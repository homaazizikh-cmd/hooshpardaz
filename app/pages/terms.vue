...
const sections = ref([
  {
    ...
    content: [
      { type: 'text', text: 'وب‌سایت داناورس تحت قوانین جمهوری اسلامی ایران، قانون تجارت الکترونیک و قانون حمایت از حقوق مصرف‌کننده فعالیت می‌کند. کاربرانی که در این وب‌سایت ثبت‌نام می‌کنند، موظف به رعایت قوانین مرتبط با کاربر هستند.' },
  ...
  },
  {
    ...
    content: [
      { type: 'text', text: 'تمامی محتواهای متنی، ویدیویی، کدهای نمونه و پروژه‌های ارائه شده در دوره‌های آموزشی، در انحصار پلتفرم داناورس می‌باشد.' },
      { type: 'list', items: [
