...
// بانک اطلاعاتی جامع ۱۳ دوره آکادمی هوش‌پرداز همراه با زمان‌بندی کلاس‌های آنلاین، ساعت و تاریخ دقیق شروع
const courses = [
  { id: 13, title: 'مهارت‌های هفت‌گانه (ICDL)', dept: 'maharat', price: '۴,۵۰۰,۰۰۰', desc: 'یادگیری کامل نرم‌افزارهای آفیس و مبانی کامپیوتر.', image: '/images/ICDL.jpg', schedule: { days: 'روزهای زوج (شنبه، دوشنبه، چهارشنبه)', time: 'ساعت ۱۶:۰۰ الی ۱۸:۰۰' }, startDate: '۱۵ تیر ۱۴۰۵' },
  { id: 5, title: 'رباتیک بزرگسال', dept: 'maharat', price: '۱۲,۰۰۰,۰۰۰', desc: 'طراحی، ساخت و برنامه‌نویسی میکروکنترلرها و ربات‌های هوشمند.', image: '/images/Robatic.jpg', schedule: { days: 'پنج‌شنبه‌ها (جلسات کارگاهی فشرده)', time: 'ساعت ۱۰:۰۰ صبح الی ۱۴:۰۰' }, startDate: '۲۰ تیر ۱۴۰۵' },
  { id: 10, title: 'اسکرچ (Scratch)', dept: 'maharat', price: '۵,۰۰۰,۰۰۰', desc: 'آموزش منطق برنامه‌نویسی و تفکر الگوریتمی برای کودکان.', image: '/images/Scratch.jpg', schedule: { days: 'یکشنبه‌ها و سه‌شنبه‌ها', time: 'ساعت ۱۷:۰۰ الی ۱۹:۰۰' }, startDate: '۱۰ مرداد ۱۴۰۵' },
  { id: 12, title: 'رباتیک دانش‌آموزی', dept: 'maharat', price: '۷,۵۰۰,۰۰۰', desc: 'آشنایی با سخت‌افزار، الکترونیک و ربات‌های حرکتی.', image: '/images/Robatoc-childern.jpg', schedule: { days: 'دوشنبه‌ها و چهارشنبه‌ها', time: 'ساعت ۱۵:۰۰ الی ۱۷:۰۰' }, startDate: '۰۵ مرداد ۱۴۰۵' },
  { id: 1, title: 'پایتون مقدماتی', dept: 'python', price: '۸,۰۰۰,۰۰۰', desc: 'شروع قدرتمند برای ورود به دنیای برنامه‌نویسی تجاری.', image: '/images/Python-M.jpg', schedule: { days: 'روزهای فرد (یکشنبه، سه‌شنبه، پنج‌شنبه)', time: 'ساعت ۱۸:۰۰ الی ۲۰:۰۰' }, startDate: '۰۱ مرداد ۱۴۰۵' },
  { id: 2, title: 'پایتون پیشرفته', dept: 'python', price: '۱۰,۰۰۰,۰۰۰', desc: 'مسلط به مباحث پیشرفته پایتون و شیءگرایی برای بازار کار.', image: '/images/Python-P.jpg', schedule: { days: 'پنج‌شنبه‌ها (کلاس آنلاین تعاملی)', time: 'ساعت ۱۵:۰۰ الی ۱۹:۰۰' }, startDate: '۱۲ مرداد ۱۴۰۵' },
  { id: 11, title: 'پایتون کودکان', dept: 'python', price: '۶,۵۰۰,۰۰۰', desc: 'زبان پایتون با بیانی ساده و جذاب برای نوجوانان.', image: '/images/Python-childern.jpg', schedule: { days: 'شنبه‌ها و دوشنبه‌ها', time: 'ساعت ۱۶:۰۰ الی ۱۸:۰۰' }, startDate: '۰۱ شهریور ۱۴۰۵' },
  { id: 3, title: 'ابزارهای هوش مصنوعی', dept: 'ai', price: '۷,۰۰۰,۰۰۰', desc: 'تسلط بر ابزارهای کاربردی و مولد هوش مصنوعی برای افزایش بهره‌وری.', image: '/images/Ai-tools.jpg', schedule: { days: 'روزهای زوج (شنبه، دوشنبه، چهارشنبه)', time: 'ساعت ۱۹:۰۰ الی ۲۱:۰۰' }, startDate: '۲۵ تیر ۱۴۰۵' },
  { id: 4, title: 'ماشین لرنینگ', dept: 'ai', price: '۱۲,۰۰۰,۰۰۰', desc: 'تحلیل داده‌ها، الگوریتم‌ها و ساخت مدل‌های هوشمند یادگیری ماشین.', image: '/images/Machine learning.jpg', schedule: { days: 'جمعه‌ها (وبینار زنده پرسش و پاسخ)', time: 'ساعت ۰۹:۰۰ صبح الی ۱۳:۰۰' }, startDate: '۳۰ تیر ۱۴۰۵' },
  { id: 6, title: 'فتوشاپ (Photoshop)', dept: 'design', price: '۷,۰۰۰,۰۰۰', desc: 'خلق جهان‌های بصری و ورود به بازار کار طراحی و ادیت عکس.', image: '/images/Photoshop.jpg', schedule: { days: 'یکشنبه‌ها و سه‌شنبه‌ها', time: 'ساعت ۱۸:۰۰ الی ۲۰:۰۰' }, startDate: '۱۵ مرداد ۱۴۰۵' },
  { id: 7, title: 'ایلاستریتور (Illustrator)', dept: 'design', price: '۷,۰۰۰,۰۰۰', desc: 'طراحی برداری، خلق کاراکترها و نشان‌های تجاری حرفه‌ای.', image: '/images/Illustrator.jpg', schedule: { days: 'دوشنبه‌ها و چهارشنبه‌ها', time: 'ساعت ۱۸:۰۰ الی ۲۰:۰۰' }, startDate: '۲۰ مرداد ۱۴۰۵' },
  { id: 8, title: 'ایندیزاین (InDesign)', dept: 'design', price: '۶,۵۰۰,۰۰۰', desc: 'صفحه‌آرایی حرفه‌ای مجلات، کتاب‌ها و کاتالوگ‌های فیزیکی و دیجیتال.', image: '/images/Indesign.jpg', schedule: { days: 'پنج‌شنبه‌ها (کلاس زنده و رفع اشکال)', time: 'ساعت ۱۴:۰۰ الی ۱۸:۰۰' }, startDate: '۰۵ شهریور ۱۴۰۵' },
  { id: 9, title: 'تصویرسازی اسکیچ', dept: 'design', price: '۶,۰۰۰,۰۰۰', desc: 'پیاده‌سازی ایده‌های خلاقانه بصری در قالب اسکیچ‌های استاندارد.', image: '/images/Sketch.jpg', schedule: { days: 'روزهای فرد (یکشنبه و سه‌شنبه)', time: 'ساعت ۱۶:۰۰ الی ۱۸:۰۰' }, startDate: '۱۵ شهریور ۱۴۰۵' }
];
